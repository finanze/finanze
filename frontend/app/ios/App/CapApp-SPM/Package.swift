...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "CapgoCapacitorSocialLogin", path: "../../../node_modules/.pnpm/@capgo+capacitor-social-login@8.3.13_@capacitor+core@8.3.0/node_modules/@capgo/capacitor-social-login"),
