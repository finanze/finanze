...
export default function EntityIntegrationsPage() {
    ...
    const unconnectedEntities =
        entities?.filter(
            (entity) => entity.status === EntityStatus.DISCONNECTED
        ) || []
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                    {connectedEntities.map((entity) => (
                                        <EntityCard
                                            ...
                                            onRelogin={() =>
                                                handleRelogin(entity)
                                            }
                                            onDisconnect={() =>
                                                handleDisconnect(entity)
                                            }
                                            isLoading={isLoading}
                                        />
                                    ))}
                                        ...
                                        <Card className="cursor-pointer transition-all hover:shadow-md border-gray-300 opacity-80">
                                            ...
                                            <CardContent>
                                                <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
                                                    {
                                                        t.entities
                                                            .userEnteredAvailableDescription
                                                    }
                                                </p>
                                                <Button
                                                    variant="outline"
