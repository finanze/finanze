...
export function RealEstateFormModal({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[50] p-2">
      <div className="bg-white dark:bg-gray-900 rounded-lg max-w-4xl w-full max-h-[95vh] relative z-[60] shadow-xl flex flex-col">
        <div className="flex-shrink-0 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 p-4 rounded-t-lg">
          <div className="flex items-center justify-between">
            <h2 className="text-xl font-semibold">
              {property ? t.realEstate.editProperty : t.realEstate.addProperty}
            </h2>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={checked =>
                        handleInputChange("basic_info.is_residence", checked)
                      }
                    />
                  </div>
              ...
              <div className="mt-4 space-y-4">
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {formData.purchase_info.expenses.map((expense, index) => (
                      <div key={index} className="flex gap-2 items-end">
                        <div className="flex-1">
                          <Input
                            placeholder={t.realEstate.placeholders.concept}
                        ...
                        <div className="w-32">
                          <div className="relative">
                            <Input
                              ...
                              min="0"
                              step="0.01"
                              placeholder={t.realEstate.placeholders.amount}
                        ...
                        >
                          <PopoverTrigger asChild>
                            <Button
                              ...
                              title={
                                t.realEstate.purchase.calculateByPercentage
                              }
                            >
                              <Percent size={16} />
                            </Button>
                            ...
                            <div className="space-y-3">
                              ...
                              <Button
                                ...
                                onClick={() => {
                                  ...
                                  if (!isNaN(percentage)) {
                                    applyPercentageToExpense(index, percentage)
                                  }
                                }}
                                disabled={
                                  !tempPercentage ||
                ...
                <div>
                  ...
                  <div className="relative">
                    <Input
                      ...
                      step="0.1"
                      value={
                        typeof formData.valuation_info.annual_appreciation ===
                        "number"
                          ? String(
                              formData.valuation_info.annual_appreciation * 100,
                            )
                          : ""
                      }
                      onChange={e =>
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <div className="relative flex-1">
                              <Input
                                ...
                                min="0"
                                step="0.01"
                                placeholder={t.realEstate.placeholders.value}
            ...
            {expandedSections.loans && (
              <div className="mt-4 space-y-4">
                    ...
                    <div className="max-h-60 overflow-y-auto space-y-2">
                      {availableFlows
                        ...
                        .sort((a, b) => {
                          ...
                          if (aIsLoanSuggestion && !bIsLoanSuggestion) return -1
                          if (!aIsLoanSuggestion && bIsLoanSuggestion) return 1
                          return 0
                        })
                        .map((flow, index) => {
                          ...
                          const iconName = getSuggestionIconName(flow, "loans")
                          return (
                            <div
                              key={`${flow.id}-${index}`}
                              className="flex items-center p-3 rounded cursor-pointer bg-gray-800 hover:bg-gray-700 transition-colors"
                            ...
                            >
                              <div className="mr-3 flex items-center justify-center w-8 h-8 rounded-full bg-gray-600">
                                <Icon
                                  name={
                                    (iconName || "square-dashed") as IconName
                                  }
                ...
                <div className="space-y-3">
                  {formData.flows
                    .filter(
                      flow => flow.flow_subtype === RealEstateFlowSubtype.LOAN,
                    )
                    .map(flow => {
                      ...
                      return (
                        ...
                        >
                                ...
                                >
                                  ...
                                  >
                                    {flow.periodic_flow?.icon ? (
                                      <Icon
                                        name={
                                          flow.periodic_flow.icon as IconName
                                        }
                                        className="w-5 h-5"
                                      />
                                    ) : (
                                ...
                                onClick={async () => {
                                  try {
                                    ...
                                    const req: LoanCalculationRequest = {
                                      ...
                                      interest_type:
                                        loanPayload.interest_type || "FIXED",
                                      euribor_rate:
                                        loanPayload.euribor_rate ?? undefined,
                                      fixed_years:
                                        loanPayload.fixed_years ?? undefined,
                                      start: startStr,
                                      end: endStr,
                                    }
                                    ...
                                    if (principalProvided) {
                                      ...
                                      showToast(
                                        t.realEstate.errors.missingLoanAmounts,
                                        "error",
                                      )
                                      return
                                    }
                                    ...
                                    console.error(e)
                                    showToast(
                                      t.realEstate.errors.loanCalculationFailed,
                                      "error",
                                    )
                                  } finally {
                            ...
                            <div>
                              ...
                              <div className="relative">
                                <Input
                                  ...
                                  min="0"
                                  step="0.01"
                                  value={loanPayload.monthly_interests || ""}
                                  onChange={e =>
                                    updateFlowPayload(
                                      originalIndex,
                                      "monthly_interests",
                          ...
                          <div className="grid grid-cols-2 gap-4 mb-4">
                            <div>
                              <Label>{t.realEstate.loans.loanTypeLabel}</Label>
                              <select
                          ...
                          <div className="grid grid-cols-2 gap-4 mb-4">
                            <div>
                              ...
                              >
                                ...
                                <option value="VARIABLE">
                                  {t.realEstate.loans.interestTypes.variable}
                                </option>
                                <option value="MIXED">
                            ...
                            loanPayload.interest_type === "MIXED" ? (
                              <div>
                                <Label>{t.realEstate.loans.euriborRate}</Label>
                                <div className="relative">
                                  <Input
                                    type="number"
                                    step="0.01"
            ...
            {expandedSections.costs && (
              <div className="mt-4 space-y-4">
                    ...
                    <div className="max-h-60 overflow-y-auto space-y-2">
                      {availableFlows
                        ...
                        .map((flow, index) => {
                          ...
                          const iconName = getSuggestionIconName(flow, "costs")
                          return (
                            <div
                              key={`${flow.id}-${index}`}
                              className="flex items-center p-3 rounded cursor-pointer bg-gray-800 hover:bg-gray-700 transition-colors"
                            ...
                            >
                              <div className="mr-3 flex items-center justify-center w-8 h-8 rounded-full bg-gray-600">
                                <Icon
                                  name={(iconName || "lightbulb") as IconName}
                                  className="w-4 h-4 text-white"
                                />
                              </div>
                              <div className="flex-1">
                ...
                <div className="space-y-3">
                  {formData.flows
                    .filter(
                      flow => flow.flow_subtype === RealEstateFlowSubtype.COST,
                    )
                    .map(flow => {
                      const originalIndex = formData.flows.findIndex(
                        f => f === flow,
                          ...
                          >
                            ...
                            >
                              ...
                              {formData.basic_info.is_rented && (
                                <Popover
                                  open={
                                    rentPercentagePopoverOpen === originalIndex
                                  }
                                  onOpenChange={open => {
                                    if (!open) {
                                      setRentPercentagePopoverOpen(null)
                                ...
                                >
                                  <PopoverTrigger asChild>
                                    <Button
                                      ...
                                      size="sm"
                                      onClick={() =>
                                        openRentPercentagePopover(originalIndex)
                                      }
                                      className="hover:bg-blue-50 hover:text-blue-600 h-10"
                                      title={
                                        t.realEstate.costs
                                  ...
                                  <PopoverContent className="w-64">
                                    <div className="space-y-3">
                                      ...
                                      <Button
                                        ...
                                        disabled={
                                          !tempRentPercentage ||
                                          isNaN(parseFloat(tempRentPercentage))
                                        }
                                        className="w-full"
                                        size="sm"
                                      >
            ...
            {expandedSections.utilities && (
              <div className="mt-4 space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  {formData.flows.filter(
                    flow => flow.flow_subtype === RealEstateFlowSubtype.SUPPLY,
                  ).length === 0 && (
                    <div className="text-center py-6 text-gray-500 dark:text-gray-400">
              ...
              {expandedSections.rent && (
                <div className="mt-4 space-y-4">
                      ...
                      <div className="max-h-60 overflow-y-auto space-y-2">
                        {availableFlows
                          ...
                          .map((flow, index) => {
                            ...
                            const iconName = getSuggestionIconName(flow, "rent")
                            return (
                              <div
                                key={`${flow.id}-${index}`}
                                className="flex items-center p-3 rounded cursor-pointer bg-gray-800 hover:bg-gray-700 transition-colors"
                        ...
                        {availableFlows.filter(
                          flow =>
                            flow.flow_type === FlowType.EARNING && !flow.linked,
                        ).length === 0 && (
                          <div className="text-sm text-gray-400 text-center py-2">
                            {t.realEstate.emptyStates.noSuggestionsAvailable}
                          </div>
                  ...
                  <div className="space-y-3">
                    ...
                    {formData.flows.filter(
                      flow => flow.flow_subtype === RealEstateFlowSubtype.RENT,
                    ).length === 0 && (
                      <div className="text-center py-6 text-gray-500 dark:text-gray-400">
          ...
          {formData.basic_info.is_rented && (
            <Card className="p-4">
              <div className="flex items-center justify-between w-full text-left">
                <h3 className="text-lg font-medium flex items-center gap-2">
                  <Calculator size={18} /> {t.realEstate.amortizations.title}
                </h3>
                <Button
                  type="button"
                  size="sm"
                  onClick={() => {
                    const list = formData.rental_data?.amortizations || []
                    const newItem = {
                      concept: "",
                      base_amount: 0,
                      percentage: 100,
              ...
              <div className="mt-4 space-y-2">
                {(formData.rental_data?.amortizations || []).map((a, idx) => (
                  <div
                    key={idx}
                    className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-12 gap-2 items-end"
                  >
                    <div className="col-span-12 md:col-span-4">
                      <Label>{t.realEstate.amortizations.concept}</Label>
                      <Input
                        value={a.concept}
                        onChange={e => {
                          const list = [
                          ...
                          list[idx] = { ...a, concept: e.target.value }
                          handleInputChange("rental_data.amortizations", list)
                        }}
                        placeholder={t.realEstate.placeholders.concept}
                        className={
                          hasValidationError(`amortizations.${idx}.concept`)
                            ? "border-red-500"
                            : ""
                        }
                      />
                      ...
                      <div className="relative">
                        <Input
                          ...
                          onChange={e => {
                            ...
                            const amount = (base * (a.percentage || 0)) / 100
                            list[idx] = { ...a, base_amount: base, amount }
                            handleInputChange("rental_data.amortizations", list)
                          }}
                    ...
                    <div className="col-span-12 sm:col-span-6 md:col-span-2">
                      <Label>{t.realEstate.amortizations.percentage}</Label>
                      <div className="relative">
                        <Input
                          type="number"
                          min="0"
                          ...
                          onChange={e => {
                            ...
                            const amount = ((a.base_amount || 0) * pct) / 100
                            list[idx] = { ...a, percentage: pct, amount }
                            handleInputChange("rental_data.amortizations", list)
                          }}
                    ...
                    <div className="col-span-12 sm:col-span-6 md:col-span-3">
                      <Label>{t.realEstate.amortizations.annual}</Label>
                      <div className="relative">
                        <Input
                          type="number"
                          min="0"
                          ...
                          onChange={e => {
                            ...
                            list[idx] = { ...a, amount: amt, percentage: pct }
                            handleInputChange("rental_data.amortizations", list)
                          }}
