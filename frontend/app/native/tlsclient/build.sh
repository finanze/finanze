...
echo ""
echo "Build complete!"
echo "  iOS: $OUTPUT_DIR/Tlsclient.xcframework"
echo ""
echo "Install:"
echo "  rm -rf ../../ios/App/Tlsclient.xcframework"
echo "  cp -R $OUTPUT_DIR/Tlsclient.xcframework ../../ios/App/"

# Step 4: Build Android AAR via gomobile
echo ""
...
if command -v gomobile &>/dev/null; then
    ...
    echo "  Android: $OUTPUT_DIR/tlsclient.aar"
    echo ""
    echo "Install Android:"
    echo "  cp $OUTPUT_DIR/tlsclient.aar ../../android/app/libs/"
else
