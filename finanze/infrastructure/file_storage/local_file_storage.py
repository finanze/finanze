...
class LocalFileStorage(FileStoragePort):
    ...
    async def save(
        ...
        if existing_url:
            existing_path = existing_url.replace(self.static_url_prefix + "/", "")
    ...
    async def save_from_url(
        ...
        return await self.save(file_upload, folder, keep_name=True)
    ...
    async def delete_by_url(self, file_url: str) -> bool:
        ...
        return await self.delete(str(file_path))
