...
from domain.historic import Historic, BaseHistoricEntry, FactoringEntry, RealStateCFEntry, ProductType
from domain.transactions import BaseInvestmentTx
from infrastructure.repository.db.client import DBClient
from infrastructure.repository.transaction.transaction_repository import _map_investment_row
...
def _map_historic_row(row) -> BaseHistoricEntry:
    ...
    common = {
        ...
        "effective_maturity": datetime.fromisoformat(
            row["effective_maturity"]) if row["effective_maturity"] else None,
        ...
        with self._db_client.tx() as cursor:
            ...
            for entry in entries:
                base_data = {
                    ...
                    "effective_maturity": entry.effective_maturity.isoformat() if entry.effective_maturity else None,
    ...
    def get_all(self, fetch_related_txs: bool = False) -> Historic:
        with self._db_client.read() as cursor:
            ...
            for entry_row in entries:
                ...
                historic_entry.related_txs = tx_mapping.get(entry_id, []) if fetch_related_txs else []
